...
module.exports = function(options) {
    ...
    gulp.task('build-test-preprocess', _.union(['nuke'], gulpTaskOptions['build-test-preprocess']), function() {
    ...
    gulp.task('build-test', _.union(['build-test-preprocess', 'build-app-preprocess', 'build-app-amd', 'copy-app-deps', 'copy-onejs-js'], gulpTaskOptions['build-test']));
